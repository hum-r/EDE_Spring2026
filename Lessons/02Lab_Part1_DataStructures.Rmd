...
#
vector_temp_F <- c(55,52,30,27,33) # Vector type: Numeric


#What is the average of these temperatures 
mean(vector_temp_F) # Vector type: Numeric

#Compute the difference between each temperature and the average calculated above

temp_diff <- vector_temp_F - mean(vector_temp_F) # Vector type: Numeric
temp_diff



#Subtract 32 and multiply by 5/9ths to create a vector in Celsius
temp_celsius <- (vector_temp_F - 32) * (5/9) # Vector type: Numeric
